...
Chris.prototype.loadAnims = function() {
    if (this.playerNumber === 2) {
        ...
        this.PunchAnimate = new Animate(this.spritesheet, 1855, 2002, 368, 460, 0.08, 3, false, true);
        ...
        this.PunchAnimate = new Animate(this.spritesheet, 20, 2002, 370, 500, 0.08, 3, false, false);
