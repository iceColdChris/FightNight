/**
 * Created by matthewmoore on 2/16/15.
 */
...
Matt.prototype.loadAnims = function() {
    if (this.playerNumber === 1) {
        this.animate = new Animate(this.spritesheet, 3000, 0, 370, 500, 0.1, 3, true, false);
        this.PunchAnimate = new Animate(this.spritesheet, 0, 1990, 370, 480, 0.05, 4, false, false);
