...
DrTolentino.prototype.loadAnims = function() {
    if (this.playerNumber === 1) {
        ...
        this.WalkAnimate = new Animate(this.spritesheet, 0, 1500, 370, 500, 0.1, 4, true, false);
        ...
        this.JumpAnimate = new Animate(this.spritesheet, 0, 1500, 370, 500, .2, 4, false, false);
        this.FallAnimate = new Animate(this.spritesheet, 1110, 1500, 370, 500, .2, 1, true, false);
